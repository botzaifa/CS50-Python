'''
Implement a program that prompts consumers users to input a fruit and then outputs the number of calories in one portion of that fruit, 
...
if y in fruits:
    value = fruits[y]
    print(f"Calories in {y} is: {value}")
else:
